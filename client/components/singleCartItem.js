...
export class SingleCartItem extends Component {
    ...
    handleSubmit(event) {
        ...
        this.props.sendAddToCart({quantity: this.state.quantity-this.props.cartItem.quantity, productId: this.props.cartItem.productId, cartId: this.props.cartId}, true)
    }
