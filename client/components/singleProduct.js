...
import {Button, Container, Image, Item, Icon, Grid, Divider, Rating, Segment, Dropdown} from 'semantic-ui-react';
						...
						<Segment>
							...
							<Grid>
								<Grid.Row>
									<Grid.Column width={12}>
										<Item>
											<Item.Content>
												...
												<Item.Meta>{quantity < 5 && `Only ${quantity} left!`}</Item.Meta>
									...
									<Grid.Column width={2}>
										<Button floated="right" onClick={this.handleSubmit} color="orange">
											<Icon name="shop" />
										</Button>
									</Grid.Column>
									{/* <Grid.Column width={2} /> */}
